...
def physical_systems(molecule:str, bond_lengths:list[int], num_layers:int, dir='results'):
    ...
    eqbm_bond_length = {'H2': 0.742, 'LiH': 1.57}
    ...
    if bond_lengths is not None:
        ...
        selected_bond_lengths = bond_lengths_dict[molecule]
    else:
...
physical_systems(molecule='H2', bond_lengths=None, num_layers=3)
